...
<footer class="relative bg-gray-900 text-white overflow-hidden">
   ...
   target="_blank" rel="noopener noreferrer">
    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path
            d="M22.675 0h-21.35C.595 0 0 .595 0 1.326v21.348C0 23.405.595 24 1.326 
        ...
        <div class="p-6 md:p-8">
            ...
            <div class="space-y-6 text-gray-700">
                ...
                <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p class="text-green-700">Your Globe Trotting Agent protects you by never accepting cash or travel payments to PayPal or other personal accounts. Purchase travel through Globe Trotting with peace of mind - your money and your dream trip are protected and secure.</p>
                </div>

                <!-- Payment Security -->
                <div class="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                    <h4 class="font-semibold text-blue-800 mb-2">Secure Payment Processing</h4>
                    <p class="text-blue-700 mb-2">Your payments always go directly to the travel supplier (hotel, cruise line, airline, etc.) or Globe Trotting.</p>
                    <p class="text-blue-700"><strong>If you are asked for cash or personal payments, call   +44 7368 818431.</strong></p>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <p>All the flight-inclusive holidays on this website are financially protected by the ATOL scheme. When you pay you will be supplied with an <strong>ATOL Certificate</strong>.</p>
                        <p>Please ask for it and check to ensure that everything you booked (flights, hotels and other services) is listed on it. If you do receive an ATOL Certificate but all the parts of your trip are not listed on it, those parts will not be ATOL protected.</p>
                        <p>Some of the flights on this website are also financially protected by the ATOL scheme, but ATOL protection does not apply to all flights. This website will provide you with information on the protection that applies in the case of each flight before you make your booking.</p>
                        <p><strong>If you do not receive an ATOL Certificate then the booking will not be ATOL protected.</strong></p>
                        <div class="bg-gray-50 p-3 rounded-lg mt-3">
                            <p class="text-sm">Find out more at: <a href="https://abta.com/go-travel/before-you-travel/travel-tips/financial-protection-3" target="_blank" class="text-blue-600 hover:underline">ABTA Financial Protection</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <p>Globe Trotting.uk is a Member of ABTA. ABTA and ABTA Members help holidaymakers to get the most from their travel and assist them when things do not go according to plan.</p>
                        <p>We are obliged to maintain a high standard of service to you by ABTA's Code of Conduct.</p>
                        <div class="bg-gray-50 p-3 rounded-lg mt-3">
                            <p class="text-sm mb-2">For further information about ABTA, the Code of Conduct and the arbitration scheme available to you if you have a complaint, contact:</p>
                            <div class="text-sm">
                                <p><strong>ABTA</strong></p>
                                <p>30 Park Street, London SE1 9EQ</p>
                                <p>Tel: 020 3117 0500</p>
                                <p><a href="https://abta.com/find-a-member" target="_blank" class="text-blue-600 hover:underline">Find ABTA Members</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <p>For the latest travel advice from the Foreign, Commonwealth and Development Office including security and local laws, plus passport and visa information:</p>
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <p class="text-sm"><a href="https://www.gov.uk/foreign-travel-advice" target="_blank" class="text-blue-600 hover:underline">UK Government Travel Advice</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                            ...
                            <p class="text-yellow-700">If you have a problem whilst on holiday, this must be reported to the relevant principal/supplier or their local supplier or agent immediately.</p>
                        </div>
                        ...
                        <p>We will of course assist you with this if you wish - please contact your Globe Trotting agent and copy Customer Services at <a href="mailto:customerservice@Globe Trotting.com" class="text-blue-600 hover:underline">customerservice@Globe Trotting.com</a></p>
                        <p>If the matter cannot be resolved and it involves us or another ABTA Member then you have the option to use ABTA's ADR scheme, approved by the Chartered Trading Standards Institute. <a href="http://www.abta.com" target="_blank" class="text-blue-600 hover:underline">Learn more at ABTA.com</a></p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div class="space-y-3 text-gray-700">
                        <div>
                            ...
                            <p class="text-sm">On this site you will find links to other third party websites. These are for your convenience only and Globe Trotting.uk is not responsible for the content of the third party site.</p>
                        </div>
                        <div>
                            <h4 class="font-semibold mb-2">Data Protection & Privacy</h4>
                            <p class="text-sm">Please see our Privacy Policy for information about what data we collect and how personal information will be used, who it will be passed to, etc. You have the right to see the personal data we hold about you, and to request modification or deletion.</p>
                        </div>
                        <div>
                            <h4 class="font-semibold mb-2">Cookies</h4>
                            <p class="text-sm">This site uses cookies as explained in our Privacy Policy. If you use this site without adjusting your cookies settings, you agree to our use of cookies.</p>
                        </div>
                    </div>
                </div>
            </div>
