            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-start gap-4 flex-1">
                    <div class="flex-shrink-0">
                        <div
                            class="w-12 h-12 bg-gradient-to-r from-blue-100 to-blue-200 rounded-full flex items-center justify-center">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">
                            ...
                            <a href="/privacy-policy"
                                class="text-blue-600 hover:text-blue-800 font-semibold underline">Learn more</a>
                        </p>
                    </div>
                </div>
