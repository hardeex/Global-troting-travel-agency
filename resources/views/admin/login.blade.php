        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-sky-100 p-8">
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 text-sm">Please enter your credentials to access the booking management system.
                    </p>
                </div>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="password" name="password" placeholder="Enter your admin password"
            ...
            <div class="text-center mt-8">
                <p class="text-sm text-gray-600">
                    Need help? <a href="{{ route('index') }}#book-now-section"
                        class="text-sky-400 hover:text-sky-500 font-medium">
                        Contact Support
                    </a>
