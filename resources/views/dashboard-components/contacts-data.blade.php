    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-sky-100 p-6 mb-8">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <div
                            class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-sky-400 to-blue-500 rounded-xl shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <!-- Total Submissions -->
                <div
                    class="bg-white rounded-xl shadow-sm border border-sky-100 p-6 hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-sky-100 to-sky-200 rounded-xl">
                ...
                <!-- Today -->
                <div
                    class="bg-white rounded-xl shadow-sm border border-green-100 p-6 hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-green-100 to-green-200 rounded-xl">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ $submissions->where('created_at', '>=', today())->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- This Week -->
                <div
                    class="bg-white rounded-xl shadow-sm border border-blue-100 p-6 hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ $submissions->where('created_at', '>=', now()->startOfWeek())->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- This Month -->
                <div
                    class="bg-white rounded-xl shadow-sm border border-purple-100 p-6 hover:shadow-md transition-shadow duration-200">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                {{ $submissions->where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-sky-100 p-6 mb-8">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div class="space-y-2">
                        ...
                        <select name="type"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-400 focus:border-sky-400 bg-white transition">
                    ...
                    <div x-data="{ open_{{ $uid }}: false }"
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                                        <div class="flex items-center bg-gray-50 rounded-lg p-3">
                                            <div
                                                class="flex-shrink-0 w-10 h-10 bg-sky-100 rounded-lg flex items-center justify-center">
                        ...
                        <div x-show="open_{{ $uid }}" x-cloak
                            ...
                            <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-auto overflow-hidden"
                                @click.stop>
                                <div
                                    class="bg-gradient-to-r from-sky-500 to-blue-600 p-6 flex justify-between items-center">
                                    <h4 class="text-xl font-bold text-white">Submission Details</h4>
                                    <button @click="open_{{ $uid }} = false"
                                            ...
                                            @if (!empty($data[$field]))
                                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-100">
                                                    <p class="text-xs font-semibold text-gray-500 uppercase mb-1">
                                                        {{ $label }}</p>
                                                    <p class="text-sm text-gray-900 font-medium">{{ e($data[$field]) }}
                                                    </p>
                                                </div>
                                            @endif
                                        @endforeach
                ...
                @empty
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-600 mb-6 max-w-md">No submissions match your current filters. Try adjusting
                                your search criteria or clear all filters.</p>
                            <a href="{{ route('admin.bookings') }}"
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-sky-100 p-6">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-600">
                                Showing <span class="font-semibold text-gray-900">{{ $submissions->firstItem() }}</span>
                                to
