                ...
                <div class="grid lg:grid-cols-5 gap-12">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:support@globetrottingtraveluk.com"
                                            class="text-lg text-slate-800 hover:text-slate-600 transition-colors">support@globetrottingtraveluk.com</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+44 1375 481962"
                                            class="text-lg text-slate-800 hover:text-slate-600 transition-colors">+44 1375
                                            481962</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg text-slate-800">Mon - Fri: 9:00 AM - 6:00 PM<br>Sat: 10:00 AM -
                                            4:00 PM</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-3">
                        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-10 border border-slate-200">
                            ...
                            @if (session('success'))
                                <div
                                    class="mb-8 bg-green-50 border border-green-200 text-green-800 rounded-xl p-4 flex items-start">
                            ...
                            <div class="mb-8">
                                ...
                                <p class="text-slate-600">Fill out the form below and we'll get back to you within 24 hours.
                                </p>
                            </div>
                            ...
                            @if ($errors->any())
                                <div
                                    class="bg-blue-50 border-l-4 border-blue-500 text-blue-800 px-4 py-3 rounded-lg mb-6 animate-shake">
                                    <ul class="space-y-1">
                                        @foreach ($errors->all() as $error)
                                            <li class="flex items-start">
                                                <svg class="w-5 h-5 mr-2 flex-shrink-0 mt-0.5" fill="currentColor"
                                                    viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                            ...
                            <form action="{{ route('form.submit') }}" method="POST" class="space-y-6"
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="email"
                                            class="block text-sm font-semibold text-slate-700 mb-2">Email Address *</label>
                                    ...
                                    <div>
                                        <label for="phone"
                                            class="block text-sm font-semibold text-slate-700 mb-2">Phone Number</label>
                                    ...
                                    <div>
                                        <label for="preferred_contact"
                                            class="block text-sm font-semibold text-slate-700 mb-2">Preferred Contact
                                            Method</label>
                                ...
                                <!-- Inquiry Type -->
                                <div>
                                    <label for="booking_type" class="block text-sm font-semibold text-slate-700 mb-2">What
                                ...
                                <div x-show="showTypeFields" x-transition:enter="transition ease-out duration-300"
                                    ...
                                    <div x-show="bookingType === 'flight'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Departure
                                                    City/Airport</label>
                                                <input type="text" name="flight_departure"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Arrival
                                                    City/Airport</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Return
                                                    Date</label>
                                                <input type="date" name="flight_return_date"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Number of
                                                    Adults</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Number of
                                                    Children</label>
                                                <input type="number" name="flight_children" min="0"
                                                    value="0"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                        </div>
                                    ...
                                    <div x-show="bookingType === 'hotel'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Check-in
                                                    Date</label>
                                                <input type="date" name="hotel_checkin"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Check-out
                                                    Date</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Total
                                                    Guests</label>
                                            ...
                                            <div class="md:col-span-2">
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Hotel
                                                    Preferences / Frequent Guest Programs</label>
                                                <input type="text" name="hotel_preferences"
                                                    placeholder="e.g., Marriott Bonvoy, Hilton Honors"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>

                                            <div class="md:col-span-2">
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Room
                                                    Features</label>
                                                <input type="text" name="hotel_room_features"
                                                    placeholder="e.g., Ocean view, Suite, All-inclusive, Adults only, Kids club"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="bookingType === 'car'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Pick-up
                                                    Location</label>
                                                <input type="text" name="car_pickup_location"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Drop-off
                                                    Location</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Driver
                                                    Age</label>
                                            ...
                                            <!-- NEW: Car Preferences -->
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Car
                                                    Category</label>
                                            ...
                                            <div class="md:col-span-2">
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Car
                                                    Preferences / Frequent Renter Programs</label>
                                                <input type="text" name="car_preferences"
                                                    placeholder="e.g., Hertz Gold Plus, Avis Preferred"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>

                                            <div class="md:col-span-2">
                                                <label
                                                    class="block text-sm font-medium text-slate-700 mb-2">Add-Ons</label>
                                                <input type="text" name="car_addons"
                                                    placeholder="e.g., GPS, Child seat, Additional driver"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="bookingType === 'activity'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Activity
                                                    Location</label>
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="activity_type"
                                                    placeholder="e.g., Safari, Hiking, City Tour"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Preferred
                                                    Date</label>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-slate-700 mb-2">Number of
                                                    Participants</label>
                                                <input type="number" name="activity_people" min="1"
                                                    value="1"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                        </div>
                                    ...
                                    <div x-show="bookingType === 'custom'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                <label
                                                    class="block text-sm font-medium text-slate-700 mb-2">Destination(s)</label>
                                                <input type="text" name="custom_destination"
                                                    placeholder="e.g., Paris, Rome, Barcelona"
                                                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                            </div>
                                            <div class="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Start
                                                        Date</label>
                                                    <input type="date" name="custom_start"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">End
                                                        Date</label>
                                                    <input type="date" name="custom_end"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Budget
                                                        Range</label>
                                                    <input type="text" name="custom_budget"
                                                        placeholder="e.g., $5,000 - $10,000"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Travel
                                                        Style</label>
                                    ...
                                    <div x-show="bookingType === 'cruise'" class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        ...
                                        <div class="space-y-4">
                                            <div class="grid md:grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Cruise
                                                        Preferences / Frequent Cruiser Programs</label>
                                                    <input type="text" name="cruise_preferences"
                                                        placeholder="e.g., Royal Caribbean Crown & Anchor"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Cruise
                                                        Itinerary</label>
                                                    <input type="text" name="cruise_itinerary"
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Cruise
                                                        Length (Nights)</label>
                                                    <input type="number" name="cruise_length" min="1"
                                                        placeholder="e.g., 7"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Pre and
                                                        Post Cruise Nights</label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Cabin
                                                        Class</label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Beverage
                                                        Plan</label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Beverage
                                                        Plan Type</label>
                                                    <input type="text" name="cruise_beverage_plan_type"
                                    ...
                                    <div x-show="bookingType === 'package_tour'"
                                        class="bg-slate-50 rounded-xl p-6 space-y-4">
                                        <h4 class="font-semibold text-slate-800 text-lg mb-4">Package Tour Details</h4>
                                        <div class="space-y-4">
                                            <div class="grid md:grid-cols-2 gap-4">
                                                <div class="md:col-span-2">
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Country or
                                                        Countries of Interest</label>
                                                    <input type="text" name="package_countries"
                                                        placeholder="e.g., Italy, France, Spain"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Tour
                                                        Type</label>
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-slate-700 mb-2">Duration
                                                        (Days)</label>
                                                    <input type="number" name="package_duration" min="1"
                                                        placeholder="e.g., 10"
                                                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-200 bg-white">
                                                </div>
                                            </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label for="hotels_enjoyed"
                                            class="block text-sm font-medium text-slate-700 mb-2">What hotels have you
                                            stayed in and enjoyed?</label>
                                    ...
                                    <div>
                                        <label for="cruises_resorts_enjoyed"
                                            class="block text-sm font-medium text-slate-700 mb-2">What cruise lines and
                                            resorts have you enjoyed before, if any?</label>
                                    ...
                                    <div>
                                        <label for="travel_activities"
                                            class="block text-sm font-medium text-slate-700 mb-2">What activities do you
                                            enjoy when travelling?</label>
                                ...
                                <div>
                                    <label for="message"
                                        class="block text-sm font-semibold text-slate-700 mb-2">Additional Details /
                                        Notes</label>
                                    ...
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <label for="marketing_consent"
                                                ...
                                                <span class="font-semibold">Stay Connected with Exclusive Travel
                                                    Offers</span>
                                            </label>
                                            <p class="text-sm text-slate-600 mt-1">
                                                Yes, I would like to receive emails, newsletters, and promotional
                                                communications about special offers, travel deals, and exclusive packages
                                                from Global Trotting Travel UK. You can unsubscribe at any time.
                                            </p>
                                        </div>
                                    </div>
                                    <p class="text-xs text-slate-500 mt-3 ml-8">
                                        By checking this box, you consent to receiving marketing communications. We respect
                                        your privacy and will never share your information with third parties. See our <a
                                            href="/privacy-policy" class="text-blue-600 hover:underline">Privacy
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    grecaptcha.ready(function() {
                        grecaptcha.execute('{{ config('services.recaptcha.site_key') }}', {
                            ...
                            .then(function(token) {
                                console.log('reCAPTCHA token generated:', token.substring(0,
                                    50) + '...');
