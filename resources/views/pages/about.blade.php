...
<section id="popular-destination" class="py-20 bg-gradient-to-r from-blue-600 to-purple-700 relative overflow-hidden">
    <div class="absolute inset-0">
        <div class="blob absolute top-10 right-10 w-64 h-64 opacity-10"></div>
        <div class="blob absolute bottom-10 left-10 w-80 h-80 opacity-10" style="animation-delay: 3s;"></div>
    </div>

    <div class="max-w-7xl mx-auto px-4 relative z-10">
        <div class="text-center mb-16 scroll-reveal">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Popular Destinations</h2>
            <p class="text-xl text-white/90 max-w-3xl mx-auto">
                Discover the world's most incredible destinations, each offering unique experiences and unforgettable memories.
            </p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Destination Cards -->
            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-orange-400 to-pink-500 relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-8xl">🏝️</span>
                    </div>
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Tropical Paradise</h3>
                        <p class="text-white/80">Maldives, Bali, Hawaii</p>
                    </div>
                </div>
            </div>
            ...
            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-blue-400 to-indigo-600 relative">
                    ...
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Mountain Adventures</h3>
                        <p class="text-white/80">Alps, Himalayas, Rockies</p>
                    </div>
                </div>
            </div>

            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-purple-400 to-red-500 relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-8xl">🏛️</span>
                    </div>
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Cultural Wonders</h3>
                        <p class="text-white/80">Rome, Kyoto, Machu Picchu</p>
                    </div>
                </div>
            </div>

            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-green-400 to-teal-500 relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-8xl">🌴</span>
                    </div>
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Safari Adventures</h3>
                        <p class="text-white/80">Kenya, Tanzania, Botswana</p>
                    </div>
                </div>
            </div>
            ...
            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-yellow-400 to-orange-500 relative">
                    ...
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Desert Mysteries</h3>
                        <p class="text-white/80">Sahara, Atacama, Gobi</p>
                    </div>
                </div>
            </div>

            <div class="destination-card rounded-xl overflow-hidden card-hover scroll-reveal">
                <div class="h-64 bg-gradient-to-br from-cyan-400 to-blue-600 relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <span class="text-8xl">🏙️</span>
                    </div>
                    <div class="absolute bottom-4 left-4 text-white">
                        <h3 class="text-2xl font-bold">Urban Escapes</h3>
                        <p class="text-white/80">Tokyo, New York, Paris</p>
                    </div>
                </div>
            </div>
        </div>
